              ...
              <section id="projects">
                <ul id="thumbs" class="grid cs-style-3 portfolio">
                  ...
                  <li class="item-thumbs span6 design" data-id="id-0" data-type="web">
                    <div class="item">
                      <figure>
                        <div><img src="img/caipirete/2.jpg" </div>
                        <figcaption>
                          
                          <p>
                            <a href="img/caipirete/2.jpg" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-zoom-in icon-circled icon-bglight icon-2x active"></i></a>
                  ...
                  <li class="item-thumbs span6 design" data-id="id-0" data-type="web">
                    <div class="item">
                      <figure>
                        <div><img src="img/caipirete/3.jpg" </div>
                        <figcaption>
                          
                          <p>
                            <a href="img/caipirete/3.jpg" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-zoom-in icon-circled icon-bglight icon-2x active"></i></a>
                  ...
                  <li class="item-thumbs span6 design" data-id="id-0" data-type="web">
                    <div class="item">
                      <figure>
                        <div><img src="img/caipirete/4.jpg" </div>
                        <figcaption>
                          
                          <p>
                            <a href="img/caipirete/4.jpg" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-zoom-in icon-circled icon-bglight icon-2x active"></i></a>
                  ...
                  <li class="item-thumbs span6 design" data-id="id-0" data-type="web">
                    <div class="item">
                      <figure>
                        <div><img src="img/caipirete/5.jpg" </div>
                        <figcaption>
                          
                          <p>
                            <a href="img/caipirete/5.jpg" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-zoom-in icon-circled icon-bglight icon-2x active"></i></a>
                   ...
                   <li class="item-thumbs span6 design" data-id="id-0" data-type="web">
                    <div class="item">
                      <figure>
                        <div><img src="img/caipirete/6.jpg" </div>
                        <figcaption>
                          
                          <p>
                            <a href="img/caipirete/6.jpg" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-zoom-in icon-circled icon-bglight icon-2x active"></i></a>
                   ...
                   <li class="item-thumbs span6 design" data-id="id-0" data-type="web">
                    <div class="item">
                      <figure>
                        <div><img src="img/caipirete/7.jpg" </div>
                        <figcaption>
                          
                          <p>
                            <a href="img/caipirete/7.jpg" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-zoom-in icon-circled icon-bglight icon-2x active"></i></a>
                   ...
                   <li class="item-thumbs span6 design" data-id="id-0" data-type="web">
                    <div class="item">
                      <figure>
                        <div><img src="img/caipirete/8.jpg" </div>
                        <figcaption>
                          
                          <p>
                            <a href="img/caipirete/8.jpg" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-zoom-in icon-circled icon-bglight icon-2x active"></i></a>
