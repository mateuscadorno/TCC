              ...
              <div class="row">
                <div class="span4">
                  <div class="inner-heading">
                    <h2>Cursos Técnicos Integrado ao Ensino Médio</h2>
                  </div>
                </div>
                <div class="span8">
                  <ul class="breadcrumb">
                    ...
                    <li class="active">Cursos Tecnicos ao</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div claas="container">
                  ...
                  <div class="pricing-content">
                    <ul>
                      <li><i class="icon-book"><br></i>O Técnico em Administração executa atividades administrativas da organização
                        ...
                        de marketing, de vendas e de finanças. Atua em organizações públicas e privadas de segmentos variados.</li>
            ...
            <div class="row">
              ...
              <div class="span4">
                <div class="pricing-box-wrap">
                  ...
                  <div class="pricing-content">
                    <ul>
                      <li><i class="icon-book"><br></i>Executar, controlar e colaborar no planejamento dos
                         processos e das operações logísticas, atendendo a suprimentos,
                         produção e distribuição de bens e serviços, em conformidade com as normas de saúde,
                         higiene, meio ambiente e segurança e legislação vigente. </li>
                      <li><i class="icon-calendar"><br></i>duração: 3 Anos</li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="span4">
                <div class="pricing-box-wrap">
                  ...
                  <div class="pricing-content">
                    <ul>
                      <li><i class="icon-book"><br></i>Atuar no desenvolvimento de projetos; controlar processos
                         de produção mecânica e realizar a manutenção mecânica de máquinas e equipamentos segundo normas técnicas,
                         considerando padrões de qualidade, de saúde e segurança no trabalho e meio ambiente</li>
                      <li><i class="icon-calendar"><br></i>duração: 3 Anos</li>
                    </ul>
                  </div>
              ...
              <div class="span4">
                <div class="pricing-box-wrap">
                  ...
                  <div class="pricing-content">
                    <ul>
                      <li><i class="icon-book"><br></i> Atuar no desenvolvimento de sistemas automatizados de manufatura,
                         implementar e manter máquinas e equipamentos automatizados,
                         respeitando procedimentos e normas técnicas, dequalidade, de saúde e segurança, e de meio ambiente
                        <br>
                        <br>
                      </li>
                      <li><i class="icon-calendar"><br></i>duração: 3 Anos</li>
            ...
            <div class="span4">
              <div class="pricing-box-wrap">
                ...
                <img src="img/meio ambiente.jpg" alt="" />
                <div class="pricing-content">
                  <ul>
                    <li><i class="icon-book"><br></i> O Técnico em Meio Ambiente é o profissional responsável pelo levantamento e sistematização de dados,
                       informações e documentos técnicos para
                       subsidiar a realização de estudos socioambientais. Contribui no processo de elaboração de políticas ambientais,
                       na implementação e controle de programas de gerenciamento ambiental e sistemas de gestão integrada.
                      <br>
                      <br>
                    </li>
                    <li><i class="icon-calendar"><br></i>duração: 3 Anos</li>
