...
<body>
 ...
 <section id="inner-headline">
        ...
        <div class="row">
          <div class="span12">
            ...
            <!-- end divider -->
             ...
             <h6>
             É uma feira, que a cada ano possui um tema, e cada turma apresenta um tipo de projeto, é aberta ao público e acontece em dois dias da semana, quarta e quinta.
            </h6>
              ...
              <section id="projects">
                <ul id="thumbs" class="grid cs-style-3 portfolio">
                  ...
                  <li class="item-thumbs span6 design" data-id="id-0" data-type="web">
                    <div class="item">
                      <figure>
                        <div><img src="img/expoete/1.jpg" </div>
                        <figcaption>
                          
                          <p>
                            <a href="img/expoete/1.jpg" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-zoom-in icon-circled icon-bglight icon-2x active"></i></a>
    ...
    <li class="item-thumbs span6 design" data-id="id-0" data-type="web">
      <div class="item">
        <figure>
          <div><img src="img/expoete/3.jpg" alt=""></div>
          <figcaption>
            <h3>Projetos</h3>
            <p>
              <a href="img/expoete/3.jpg" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-zoom-in icon-circled icon-bglight icon-2x active"></i></a>
    ...
    <li class="item-thumbs span6 design" data-id="id-0" data-type="web">
      <div class="item">
        <figure>
          <div><img src="img/expoete/4.jpg" alt=""></div>
          <figcaption>
            <h3>Projetos</h3>
            <p>
              <a href="img/expoete/4.jpg" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-zoom-in icon-circled icon-bglight icon-2x active"></i></a>
    ...
    <li class="item-thumbs span6 design" data-id="id-0" data-type="web">
      <div class="item">
        <figure>
          <div><img src="img/expoete/5.jpg" alt=""></div>
          <figcaption>
            <h3>Projetos</h3>
            <p>
              <a href="img/expoete/5.jpg" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-zoom-in icon-circled icon-bglight icon-2x active"></i></a>
    ...
    <li class="item-thumbs span6 design" data-id="id-0" data-type="web">
      <div class="item">
        <figure>
          <div><img src="img/expoete/6.jpg" alt=""></div>
          <figcaption>
            <h3>Projetos</h3>
            <p>
              <a href="img/expoete/6.jpg" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-zoom-in icon-circled icon-bglight icon-2x active"></i></a>
    ...
    <li class="item-thumbs span6 design" data-id="id-0" data-type="web">
      <div class="item">
        <figure>
          <div><img src="img/expoete/7.jpg" alt=""></div>
          <figcaption>
            <h3>Projetos</h3>
            <p>
              <a href="img/expoete/7.jpg" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-zoom-in icon-circled icon-bglight icon-2x active"></i></a>
    ...
    <li class="item-thumbs span6 design" data-id="id-0" data-type="web">
      <div class="item">
        <figure>
          <div><img src="img/expoete/8.jpg" alt=""></div>
          <figcaption>
            <h3>Projetos</h3>
            <p>
              <a href="img/expoete/8.jpg" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-zoom-in icon-circled icon-bglight icon-2x active"></i></a>
    ...
    <li class="item-thumbs span6 design" data-id="id-0" data-type="web">
      <div class="item">
        <figure>
          <div><img src="img/expoete/9.jpg" alt=""></div>
          <figcaption>
           <h3>Projetos</h3>
            <p>
              <a href="img/expoete/9.jpg" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-zoom-in icon-circled icon-bglight icon-2x active"></i></a>
    ...
    <li class="item-thumbs span6 design" data-id="id-0" data-type="web">
      <div class="item">
        <figure>
          <div><img src="img/expoete/10.jpg" alt=""></div>
          <figcaption>
            <h3>Projetos</h3>
            <p>
              <a href="img/expoete/10.jpg" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-zoom-in icon-circled icon-bglight icon-2x active"></i></a>
     ...
     <li class="item-thumbs span6 design" data-id="id-0" data-type="web">
      <div class="item">
        <figure>
          <div><img src="img/expoete/11.jpg" alt=""></div>
          <figcaption>
            <h3>Projetos</h3>
            <p>
              <a href="img/expoete/11.jpg" data-pretty="prettyPhoto[gallery1]" title="Portfolio caption here"><i class="icon-zoom-in icon-circled icon-bglight icon-2x active"></i></a>
